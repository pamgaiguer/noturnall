	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-md-7">
				<br>
				<div id="last-news">
					<img src="images/noturnall-simbolo.png"><span>ÚLTIMAS NOTÍCIAS</span>
					<br>
					<hr>
				...
				<div id="youtube-channel">
					...
					<hr>
					<div class="flex-video widescreen" style="margin: 0 auto;text-align:center;">
						<iframe width="560" height="315" src="http://www.youtube.com/embed/ThADt6FMzBc" frameborder="0" allowfullscreen class="center-block"> </iframe>
					</div>
					<Br>
						<br>
						<hr>
						<div class="flex-video widescreen" style="margin: 0 auto;text-align:center;">
							<iframe width="560" height="315" src="//www.youtube.com/embed/VYHy1i-XKo4" frameborder="0" allowfullscreen class="center-block"> </iframe><br>
						</div>
						<p style="font-size: 18px; font-family: 'TranjanPro';" class="text-center">VEJA TODOS OS VÍDEOS EM NOSSO CANAL <a href="http://www.youtube.com/channel/UC_iaU7yqpRG5QASwN2dM_jA/videos" target="_blank"><img src="images/youtube-icon.png"></a></p>
					</div>
					<hr>
				</div>
				<div class="col-xs-12 col-md-5">
					...
					<div id="tour-dates" class="table-responsive">
						<img src="images/noturnall-simbolo.png"><span>DATAS</span>
					...
					<div id="merch-page">
						...
						<br>
						<a href="loja.php"><img src="images/tshirt01.jpg" class="img-responsive"></a>
						<br>
						<br>
						<a href="loja.php"><img src="images/tshirt02.jpg" class="img-responsive"></a>
					</div>
				</div>
			</div>
		</div>
